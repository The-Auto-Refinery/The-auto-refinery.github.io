(function($){
  ...
  $(function(){
    ...
    const $carousel = $('.reviews-carousel-v2');
    if (!$carousel.length) return;
    
    const $wrapper = $carousel.find('.rcv2-wrapper');
    const $track = $carousel.find('.rcv2-track');
    const $slides = $carousel.find('.rcv2-slide');
    const $dots = $carousel.find('.rcv2-dot');
    const $prev = $carousel.find('.rcv2-btn.prev');
    const $next = $carousel.find('.rcv2-btn.next');
    ...
    let resizeTimer; 
    $(window).on('resize.rcv2', function(){ 
